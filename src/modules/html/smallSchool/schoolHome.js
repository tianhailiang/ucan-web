...
require('/modules/css/swiper-3.4.2.min.css');

var Swiper=require('modules/lib/swiper-3.4.2.min.js');
...
var SchoolList = Vue.extend({
  ...
  mounted:function(){
         ...
         axios.get("http://localhost:8080/getmock/school/schoolList.json ",{
...
var schoolBanner=Vue.extend({
    template:"#schoolBanner",
     props:{
        rows:{
          type:Array,
          default:[]
    ...
    mounted:function(){
     ...
     // console.log(this.$refs.schoolSwiper)

          var mySwiper = new Swiper(this.$refs.schoolSwiper, {
               autoplay: 3000,
               setWrapperSize :true,
               loop:true,
...
var SchoolDetail=Vue.extend({
  ...
  mounted:function(){
    ...
    axios.get("http://localhost:8080/getmock/school/schoolDetail.json",{
  ...
  components: {
    ...
    mounted:function(){
        ...
        if(this.$route.query.type==0){
         ...
         axios.get("http://localhost:8080/getmock/school/newsInformation.json",{
            params:{
