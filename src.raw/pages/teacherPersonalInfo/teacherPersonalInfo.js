...
$(function () {
    ...
    $.ajax({
        type: "GET",
        url: "/api/view/user/system/user/info?token="+token+"&"+new Date().getTime(),
        success: function (data){
            ...
            if(data.code==0) {
                ...
                var html = "<li><span>姓名:</span><span>" + myData.name + "</span></li>\
                        ...
                        <li><span>个人简介:</span><span>" + myData.about + "</span></li>\
                ...
                $("ul.info-key li.my_content").before(html);
...
$(".canbox-3").on("click",".c-off",function () {
    $(".canbox").slideUp();
